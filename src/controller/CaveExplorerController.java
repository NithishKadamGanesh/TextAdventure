...
public class CaveExplorerController implements AdventureControllerInterface {
	...
	public CaveExplorerController(AdventureModelInterface model, AdventureViewInterface view, Runnable onAdventureEnd) {
		this.model = model;
		this.view = view;
