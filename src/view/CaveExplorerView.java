...
//View for the Cave Explorer Adventure.
//Displays a simple layout for the user to interact with the cave exploration.

public class CaveExplorerView implements AdventureViewInterface {
	...
	public CaveExplorerView() {
		frame = new JFrame("Cave Explorer Adventure");
		...
		descriptionArea.setEditable(false); // Make the actions read-only
		...
		actionsArea.setEditable(false); // Make the actions read-only
		...
		inputPanel.add(new JLabel("Enter action (e.g., 'explore cave')"));
